...
public class LoginTest {
    ...
    /**
     * Test of getCell_phone_number method, of class Login.
     */
    @Test
    public void testGetCell_phone_number() {
        System.out.println("getCell_phone_number");
        Login instance = null;
        String expResult = "";
        String result = instance.getCell_phone_number();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testCheckCellPhoneNumber() {
        ...
        boolean expResult = false;
        boolean result = Login.checkCellPhoneNumber(cell_phone_number);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
