...
//getters
 ...
 public static boolean checkUserName(String username) {
    ...
    if (matcher.matches()) {
        ...
        System.out.println("Username is not correctly formatted, please ensure that your username contains an underscore, an uppercase letter, a lowercase letter, and is no more than five characters in length.");
        return false;
    } 
}
